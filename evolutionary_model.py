...
def evolutionary_dynamics(init_population_size, 
    ...
    population_counter = [100 for ii in range(init_population_size)]# keeps track of the number
    ...
    for t in range(n_generations):
        ...
        for ii in range(population_size):
            for jj in range(ii, population_size):
                total_profit, _, _ = go_fishing(2, max_time=t_max, list_of_fishers=[population[ii], population[jj]])
